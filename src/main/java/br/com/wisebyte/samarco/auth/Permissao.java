...
public enum Permissao {
    ...
    LISTAR_UNIDADE( "Permite listar unidades" ),
    ...
    LISTAR_DISTRIBUIDORA( "Permite listar distribuidoras" ),
    ...
    LISTAR_FORNECEDOR( "Permite listar fornecedores" ),
    ...
    LISTAR_USUARIO( "Permite listar usuários" ),
