...
/**
 * Representa a demanda de potência elétrica contratada (kW) por unidade e horário.
 *
 * Chave única: (revisao + unidade + horario)
 * Só pode existir uma demanda para cada combinação.
 */
@Getter
@Setter
@Entity
...
@Table(
    uniqueConstraints = {
        @UniqueConstraint(
            ...
            columnNames = {"revisao_id", "unidade_id", "horario"}
        )
    }
)
