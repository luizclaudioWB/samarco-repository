...
@ApplicationScoped
public class GeracaoMapper implements EntityMapper<Geracao, GeracaoDTO> {
    ...
    @Override
    public Geracao toEntity(GeracaoDTO dto) {
    ...
    @Override
    public GeracaoDTO toDTO(Geracao entity) {
        return GeracaoDTO.builder()
            .id(entity.getId())
            .revisaoId(
